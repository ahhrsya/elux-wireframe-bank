  ...
  return (
    <SectionContainer background="neutral-100" padding="default">
      ...
      <div className="text-center mb-12">
        <Badge variant="accent" className="mb-4">Team D</Badge>
        <h2 className="text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl mb-4">Meet our leadership</h2>
        <p className="text-neutral-600 max-w-2xl mx-auto">We're a dynamic group of individuals who are passionate about what we do.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="text-center">
            ...
            <h3 className="text-lg font-semibold text-neutral-900">Member {i} Name</h3>
