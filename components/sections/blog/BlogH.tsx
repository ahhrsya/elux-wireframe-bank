  ...
  return (
    <SectionContainer background="neutral-900" padding="default">
      ...
      <div className="flex items-end justify-between mb-12">
        <div>
          <Badge variant="ghost" className="mb-4">Blog H</Badge>
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Latest from the blog</h2>
        </div>
